...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <Wrapper>
      <div className="bg-dark-card rounded-xl shadow-2xl overflow-hidden flex flex-col h-full transition-all duration-300 hover:shadow-brand-primary/30 hover:scale-[1.02] cursor-pointer">
        <img 
